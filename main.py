...
from app.db_models import create_db_and_tables, get_async_session
...
from app.schemas.enums import CurrencyEnum, TransactionStatusEnum, UserStatusEnum
...
@app.get('/users', response_model=Optional[list[ResponseUserModel]] | None, status_code=status.HTTP_200_OK)
async def get_users(
...
@app.get('/transactions', response_model=Optional[list[TransactionModel]] | None, status_code=status.HTTP_200_OK)
async def get_transactions(user_id: Optional[int] = None, session: AsyncSession = Depends(get_async_session)) -> list[TransactionModel]:
...
@app.post('/{user_id}/transactions', response_model=Optional[TransactionModel] | None, status_code=status.HTTP_200_OK)
...
@app.patch('/{user_id}/transactions/{transaction_id}', response_model=Optional[TransactionModel] | None)
...
@app.get('/transactions/analysis', response_model=Optional[list] | None, status_code=status.HTTP_200_OK)
